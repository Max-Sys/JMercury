...
public class ServerInstanceDialog extends javax.swing.JDialog {

    public ServerInstanceDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ServerInstanceDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
        pdm.closeResultSet();
