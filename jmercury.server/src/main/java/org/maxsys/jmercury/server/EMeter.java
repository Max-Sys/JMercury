...
public class EMeter {
    ...
    private volatile int osvTestCounter = 0;
    ...
    public void setOsvTestCounter(int TestCounter) {
        this.osvTestCounter = TestCounter;
    }

    public int getOsvTestCounter() {
        return this.osvTestCounter;
    }
}
